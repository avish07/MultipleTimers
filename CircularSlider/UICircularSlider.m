...
- (void)setup {
    ...
    self.minimumTrackTintColor = [UIColor colorWithRed:0.0/255.0 green:186.0/255.0 blue:140.0/255.0 alpha:1.0];
    self.maximumTrackTintColor = [UIColor colorWithRed:242.0/255.0 green:242.0/255.0 blue:242.0/255.0 alpha:1.0];
    self.thumbTintColor = [UIColor colorWithRed:242.0/255.0 green:242.0/255.0 blue:242.0/255.0 alpha:1.0];
	self.continuous = YES;
